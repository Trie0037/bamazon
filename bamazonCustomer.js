            ...
            inquirer
                .prompt([{
                        ...
                        choices: function () {
                            var choiceArray = [];
                            for (var i = 0; i < res.length; i++) {
                                choiceArray.push(res[i].id.toString() + " " + res[i].productName);
                            }
                            return choiceArray;
                        },
                ...
                .then(function (answer) {
                    ...
                    inquirer.prompt([{
                        ...
                        validate: function (value) {
                            ...
                            if ((isNaN(value) === false) && (res[chosenQuantity].stockQuantity >= parseInt(value))) {
                                return true;
                            }
                        ...
                        connection.query(
                            "UPDATE products SET ? WHERE ?", [{
                                    stockQuantity: (res[chosenQuantity].stockQuantity - ans.quantityPurchased)
                                },
                                {
                                    id: chosenQuantity + 1
                                }
                        ...
                        console.log("\nCongratulations. You have purchased " + ans.quantityPurchased + " " +
                            res[chosenQuantity].productName + "(s) @ $" + res[chosenQuantity].price + " for a grand total of: $" +
